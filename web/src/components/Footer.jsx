            ...
            <div className="footer-powered">
              ...
              <div className="powered-logos">
                <div className="powered-item">
                  <img src="/nirmaan-logo.png" alt="Nirmaan" className="powered-logo" />
                  <span className="powered-name">Nirmaan</span>
                </div>
                <div className="powered-item">
                  <img src="/iitm-logo.png" alt="IIT Madras" className="powered-logo" />
                  <span className="powered-name">IIT Madras</span>
                </div>
              </div>
            </div>
          </div>
